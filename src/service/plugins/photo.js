...
var Plugin = GObject.registerClass({
    ...
    handlePacket(packet) {
        if (packet.body.type === 'kdeconnect.photo.request' && this.camera) {
            this._sendPhoto();
        } else if (packet.body.type === 'kdeconnect.photo') {
    ...
    async _receivePhoto(packet) {
        ...
        try {
            file = imports.service.plugins.share._getFile(packet.body.filename);
